...
public class RobotContainer {
  ...
  // Joysticks
  private final XboxController opperater = new XboxController(1);
  ...
  private void configureButtonBindings() {
    ...
    driver_aButton.whileHeld(new RunAgitator(false, m_towerSubsystem));
    driver_bButton.whileHeld(new RunAgitator(true, m_towerSubsystem));
    driver_xButton.whileHeld(new RunTransferWheel(false, m_towerSubsystem));
    driver_yButton.whileHeld(new RunTransferWheel(true, m_towerSubsystem));
