...
public class Auton_TwoBall_A extends CommandBase {
    ...
    public Auton_TwoBall_A(FlywheelSubsystem flywheelSubsystem, TransferWheelSubsystem transferWheelSubsystem, IntakeSubsystem intakeSubsystem, DrivetrainSubsystem drivetrainSubsystem, TowerSubsystem towerSubsystem) {
