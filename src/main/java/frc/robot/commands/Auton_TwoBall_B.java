...
public class Auton_TwoBall_B extends CommandBase {
    ...
    public Auton_TwoBall_B(FlywheelSubsystem flywheelSubsystem, TransferWheelSubsystem transferWheelSubsystem, IntakeSubsystem intakeSubsystem, DrivetrainSubsystem drivetrainSubsystem, TowerSubsystem towerSubsystem) {
    ...
    public void initialize() {
        ...
        m_commandScheduler.schedule(new SequentialCommandGroup(
            ...
            new RunTransferWheel(true, m_transferWheelSubsystem).withTimeout(0.2),
            new ParallelCommandGroup(
                new SpinFlywheel(m_flywheelSubsystem),
